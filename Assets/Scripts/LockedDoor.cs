...
public class LockedDoor : MonoBehaviour {
    ...
    //Type of door. Blue is 0, yellow is 1, red is 2.
    public int colour;

    public bool locked;

    //This object keeps track of the player's keys/
    ...
    void OnTriggerEnter(Collider col) {
        if (col.gameObject.CompareTag("Player")) {
            ...
            if ((colour == 0 && keyManager.blue == true) || (colour == 1 && keyManager.yellow == true) || (colour == 2 && keyManager.red == true)) {
                locked = false;
            }
